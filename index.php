...
<body>
    ...
    <div id="container">
        <form action="index.php" method="POST">
            <label for="name">
                <input type="text" id="name" placeholder="Enter your name" title="Enter your name">
            </label>
            <label for="first_name">
                <input type="text" id="first_name" placeholder="Enter your first name" title="Enter your first name">
            </label>
            <br>
            <label for="man">Man:
            ...
            <br>
            <textarea id="message" name="message" rows="5" cols="50" placeholder="Enter here your request"></textarea>
            <br>
    ...
    function sanitize($input){   
        return strip_tags(trim($input));//trim evite les espaces blanc, strip tags supprimer les balises html et php 
    }
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_btn'])) {
        $recaptcha = new \ReCaptcha\ReCaptcha("6LfpRPUpAAAAAOMAmVKhHBgiaHX-Tm73rbvjXHou");
        ...
        if ($resp->isSuccess()) {
            ...
            echo "Captcha verification failed. Errors: " . implode(', ', $errors);
        }
    }
